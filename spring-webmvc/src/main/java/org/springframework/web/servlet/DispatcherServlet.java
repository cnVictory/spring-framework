...
public class DispatcherServlet extends FrameworkServlet {
	...
	protected HandlerExecutionChain getHandler(HttpServletRequest request) throws Exception {
		if (this.handlerMappings != null) {
			// 这里handlerMappings有2个实现： BeanNameUrlHandlerMapping和RequestMappingHandlerMapping
			// beanNameUrlHandlerMapping用来处理实现Controller接口的前端控制器
			// RequestMappingHandlerMapping用来处理加了@Controller注解的前端控制器
